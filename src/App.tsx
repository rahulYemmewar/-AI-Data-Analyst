  ...
  const simulateGeneratingSQL = (intent: string): Promise<GeneratedSQL> => {
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        ...
        else if (lowerCaseIntent.includes('product') || lowerCaseIntent.includes('products')) {
  ...
  const simulateQueryingDatabase = (sql: string): Promise<TableRow[]> => {
    return new Promise((resolve) => {
      setTimeout(() => {
        ...
        } else if (sql.toLowerCase().includes('product') || sql.toLowerCase().includes('sale') || sql.toLowerCase().includes('category')) { 
          resolve([
