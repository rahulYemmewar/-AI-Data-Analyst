...
const QueryInput: React.FC<QueryInputProps> = ({ onSubmit, isLoading }) => {
  ...
  return (
    <div className="flex justify-center items-center min-h-[200px] w-full">
      ...
      >
        {/* Changed from input type="text" to textarea based on your provided code */}
        <textarea
          value={query}
          ...
          disabled={isLoading}
          rows={2} // Added rows attribute for textarea
        />
        {/* <button
                type="submit"
                className="w-[50%] bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full mt-2"
                disabled={isLoading}
                // ADDED THIS LINE: Provide an accessible label for the button
